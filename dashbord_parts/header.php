...
$id = $_SESSION['id'];
$select_profile = "SELECT * FROM users WHERE id=$id";
$select_profile_result = mysqli_query($db_connection,$select_profile) ;
$after_assos_info = mysqli_fetch_assoc($select_profile_result);
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-header wd-200">
                        <ul class="list-unstyled user-profile-nav">
                            <li><a href="../users/edit_profile.php"><i class="icon ion-ios-person-outline"></i> Edit Profile</a></li>
